...
(function()
{
	...
	Sidebar.prototype.addAWS4ArrowsPalette = function(s, gn, sb)
	{
		...
		[
			...
			this.createEdgeTemplateEntry('edgeStyle=orthogonalEdgeStyle;html=1;endArrow=block;elbow=vertical;startArrow=none;endFill=1;strokeColor=#545B64;rounded=0;',
					s * 100, s * 0, '', 'Default (right)', null, this.getTagsForStencil(gn, '', dt + 'default right').join(' ')),
			...
			this.createEdgeTemplateEntry('edgeStyle=orthogonalEdgeStyle;html=1;endArrow=openThin;elbow=vertical;startArrow=none;endFill=0;strokeColor=#545B64;rounded=0;',
					s * 100, s * 0, '', 'Open (thin, right)', null, this.getTagsForStencil(gn, '', dt + 'open thin right').join(' ')),
			...
			this.createEdgeTemplateEntry('edgeStyle=orthogonalEdgeStyle;html=1;endArrow=open;elbow=vertical;startArrow=none;endFill=0;strokeColor=#545B64;rounded=0;',
					s * 100, s * 0, '', 'Open (right)', null, this.getTagsForStencil(gn, '', dt + 'open right').join(' ')),
	...
	Sidebar.prototype.addAWS4AnalyticsPalette = function(s, w, h, w2, gn, sb, pts)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.elasticsearch_service;',
					 w2, w2, '', 'OpenSearch Service', null, null, this.getTagsForStencil(gn, 'opensearch open search service elasticsearch', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.kinesis_data_firehose;',
					 w2, w2, '', 'Data Firehose', null, null, this.getTagsForStencil(gn, 'data firehose kinesis data firehose', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.managed_service_for_apache_flink;',
					 w2, w2, '', 'Managed Service for Apache Flink', null, null, this.getTagsForStencil(gn, 'managed service for apache flink kinesis data analytics', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.managed_streaming_for_kafka;',
					 w2, w2, '', 'Managed Streaming for Apache Kafka', null, null, this.getTagsForStencil(gn, 'managed streaming for apache kafka msk', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'redshift_query_editor_v20_light;',
					 s * 78, s * 78, '', 'Redshift Query Editor v2.0', null, null, this.getTagsForStencil(gn, 'redshift query editor v20 light sql workbench', dt).join(' '))
		]);
	};
	...
	Sidebar.prototype.addAWS4ApplicationIntegrationPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n + 'event;',
					 s * 78, s * 78, '', 'Event', null, null, this.getTagsForStencil(gn, 'event event resource', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4CloudFinancialManagementPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.cost_management;',
					 w2, w2, '', 'Cloud Financial Management', null, null, this.getTagsForStencil(gn, 'cost management cloud financial management', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.finops_agent;',
					 w2, w2, '', 'FinOps Agent', null, null, this.getTagsForStencil(gn, 'finops agent', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4BusinessApplicationsPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.business_application;',
					 w2, w2, '', 'Business Applications', null, null, this.getTagsForStencil(gn, 'business application applications', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.quick_suite;',
					 w2, w2, '', 'Quick', null, null, this.getTagsForStencil(gn, 'quick suite quicksight', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.workdocs;',
					 w2, w2, '', 'WorkDocs SDK', null, null, this.getTagsForStencil(gn, 'workdocs sdk software development kit', dt).join(' ')),
	...
	{
		var n2 = 'sketch=0;points=[[0,0,0],[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0,0],[0,1,0],[0.25,1,0],[0.5,1,0],[0.75,1,0],[1,1,0],[0,0.25,0],[0,0.5,0],[0,0.75,0],[1,0.25,0],[1,0.5,0],[1,0.75,0]];outlineConnect=0;fontColor=#232F3E;fillColor=#DD344C;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + "=mxgraph.aws4.";
		var dt = 'aws amazon web service contact center customer experience ';

		this.addPaletteFunctions('aws4Contact Center', 'AWS / Customer Experience', false,
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.contact_center;',
					 w2, w2, '', 'Customer Experience', null, null, this.getTagsForStencil(gn, 'contact center customer experience', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.connect;',
					 w2, w2, '', 'Connect', null, null, this.getTagsForStencil(gn, 'connect', dt).join(' '))
		]);
	};
	...
	Sidebar.prototype.addAWS4ContainersPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.eks;',
					 w2, w2, '', 'Elastic Kubernetes Service', null, null, this.getTagsForStencil(gn, 'elastic container service eks for kubernetes eks cloud', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.red_hat_openshift;',
					 w2, w2, '', 'Red Hat OpenShift Service on AWS', null, null, this.getTagsForStencil(gn, 'red hat openshift service on rosa', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4DatabasePalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4Database', 'AWS / Databases', false,
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.database;',
					 w2, w2, '', 'Databases', null, null, this.getTagsForStencil(gn, 'database databases', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4DeveloperToolsPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.fault_injection_simulator;',
					 w2, w2, '', 'Fault Injection Service', null, null, this.getTagsForStencil(gn, 'fault injection service simulator fis', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.application_composer;',
					 w2, w2, '', 'Infrastructure Composer', null, null, this.getTagsForStencil(gn, 'infrastructure composer application composer', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4EndUserComputingPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.desktop_and_app_streaming;',
					 w2, w2, '', 'End User Computing', null, null, this.getTagsForStencil(gn, 'desktop and app streaming end user computing', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.workspaces;',
					 w2, w2, '', 'WorkSpaces', null, null, this.getTagsForStencil(gn, 'workspaces workspaces family', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4FrontEndWebMobilePalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.mobile;',
					 w2, w2, '', 'Front-End Web & Mobile', null, null, this.getTagsForStencil(gn, 'mobile front end web', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4GamesPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.gamelift_2;',
					 w2, w2, '', 'GameLift Servers', null, null, this.getTagsForStencil(gn, 'gamelift servers', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.open_3d_engine_2;',
					 w2, w2, '', 'Open 3D Engine', null, null, this.getTagsForStencil(gn, 'open 3d engine o3de lumberyard', dt).join(' '))
		]);
	};
	...
	Sidebar.prototype.addAWS4InternetOfThingsPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.greengrass;',
					 w2, w2, '', 'IoT Greengrass', null, null, this.getTagsForStencil(gn, 'iot greengrass', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'alexa_voice_service_2;',
					 s * 78, s * 78, '', 'Alexa Voice Service', null, null, this.getTagsForStencil(gn, 'alexa voice service', dt).join(' ')),
			 this.createVertexTemplateEntry(n + 'alexa_enabled_device_2;',
			 ...
			 this.createVertexTemplateEntry(n + 'bicycle;',
					 s * 78, s * 78, '', 'Bicycle', null, null, this.getTagsForStencil(gn, 'iot thing bicycle', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'iot_certificate;',
					 s * 60, s * 78, '', 'IoT Certificate', null, null, this.getTagsForStencil(gn, 'iot certificate', dt).join(' ')),
			 this.createVertexTemplateEntry(n + 'lambda_function;',
	...
	Sidebar.prototype.addAWS4ArtificialIntelligencePalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.machine_learning;',
					 w2, w2, '', 'Artificial Intelligence', null, null, this.getTagsForStencil(gn, 'machine learning artificial intelligence ai', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.augmented_ai;',
					 w2, w2, '', 'Augmented AI (A2I)', null, null, this.getTagsForStencil(gn, 'augmented ai a2i', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.sagemaker;',
					 w2, w2, '', 'SageMaker AI', null, null, this.getTagsForStencil(gn, 'sagemaker ai', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.elemental_inference;',
					 w2, w2, '', 'Elemental Inference', null, null, this.getTagsForStencil(gn, 'elemental inference', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4ManagementGovernancePalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4Management Governance', 'AWS / Management Tools', false,
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.management_and_governance;',
					 w2, w2, '', 'Management Tools', null, null, this.getTagsForStencil(gn, 'management and governance tools', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.multicloud_and_hybrid;',
					 w2, w2, '', 'Multicloud and Hybrid', null, null, this.getTagsForStencil(gn, 'multicloud and hybrid category', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.managed_service_for_grafana;',
					 w2, w2, '', 'Managed Grafana', null, null, this.getTagsForStencil(gn, 'managed service for grafana managed grafana', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.console_mobile_application;',
					 w2, w2, '', 'Console Mobile Application', null, null, this.getTagsForStencil(gn, 'console mobile application app', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.personal_health_dashboard;',
					 w2, w2, '', 'Health Dashboard', null, null, this.getTagsForStencil(gn, 'personal health dashboard health dashboard', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.sustainability;',
					 w2, w2, '', 'Sustainability', null, null, this.getTagsForStencil(gn, 'sustainability', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'instances_2;',
					 s * 78, s * 78, '', 'Instances', null, null, this.getTagsForStencil(gn, 'instances', dt).join(' ')),
			 this.createVertexTemplateEntry(n + 'logs;',
					 s * 57, s * 78, '', 'Logs', null, null, this.getTagsForStencil(gn, 'logs', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4MediaServicesPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			...
			this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.interactive_video;',
					w2, w2, '', 'Interactive Video Service', null, null, this.getTagsForStencil(gn, 'interactive video service ivs', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4MigrationModernizationPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.migration_and_transfer;',
					 w2, w2, '', 'Migration & Modernization', null, null, this.getTagsForStencil(gn, 'migration and transfer modernization', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.elastic_vmware_service;',
					 w2, w2, '', 'Elastic VMware Service', null, null, this.getTagsForStencil(gn, 'elastic vmware service', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.cloudendure_migration;',
					 w2, w2, '', 'Application Migration Service', null, null, this.getTagsForStencil(gn, 'cloudendure application migration service mgn', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.transfer_family;',
					 w2, w2, '', 'Transfer Family', null, null, this.getTagsForStencil(gn, 'transfer family transfer for sftp', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4NetworkContentDeliveryPalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.networking_and_content_delivery;',
					 w2, w2, '', 'Networking & Content Delivery', null, null, this.getTagsForStencil(gn, 'networking and content delivery', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.api_gateway;',
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.application_recovery_controller;',
					 w2, w2, '', 'Application Recovery Controller', null, null, this.getTagsForStencil(gn, 'application recovery controller route 53 application recovery controller', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.interconnect;',
					 w2, w2, '', 'Interconnect', null, null, this.getTagsForStencil(gn, 'interconnect', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'cloud_wan_core_network_edge;',
					 s * 78, s * 78, '', 'Cloud WAN Core Network Edge', null, null, this.getTagsForStencil(gn, 'cloud wan core network edge wide area network', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'cloud_wan_virtual_pop;',
					 s * 78, s * 78, '', 'Cloud WAN Virtual PoP', null, null, this.getTagsForStencil(gn, 'cloud wan virtual pop wide area network', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4SecurityIdentityCompliancePalette = function(s, w, h, w2, gn, sb)
	{
		...
		this.addPaletteFunctions('aws4Security Identity Compliance', 'AWS / Security & Identity', false,
		[
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.security_identity_and_compliance;',
					 w2, w2, '', 'Security & Identity', null, null, this.getTagsForStencil(gn, 'security identity and compliance', dt).join(' ')),
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.cloud_directory;',
					 w2, w2, '', 'Cloud Directory', null, null, this.getTagsForStencil(gn, 'cloud directory', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.single_sign_on;',
					 w2, w2, '', 'IAM Identity Center', null, null, this.getTagsForStencil(gn, 'single sign on sso iam identity center', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'aws_managed_microsoft_ad;',
					 s * 78, s * 76, '', 'AWS Managed Microsoft AD', null, null, this.getTagsForStencil(gn, 'directory service aws managed microsoft ad active directory', dt).join(' ')),
	...
	Sidebar.prototype.addAWS4StoragePalette = function(s, w, h, w2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.fsx_for_windows_file_server;',
					 w2, w2, '', 'FSx for Windows File Server', null, null, this.getTagsForStencil(gn, 'fsx for windows file server wfs', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.cloudendure_disaster_recovery;',
					 w2, w2, '', 'Elastic Disaster Recovery', null, null, this.getTagsForStencil(gn, 'cloudendure elastic disaster recovery drs', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'elastic_file_system_infrequent_access;',
					 s * 78, s * 76, '', 'Elastic File System Standard Infrequent Access', null, null, this.getTagsForStencil(gn, 'efs elastic file system standard infrequent access efs infrequent access', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 'elastic_file_system_standard;',
					 s * 78, s * 78, '', 'Elastic File System Standard', null, null, this.getTagsForStencil(gn, 'efs elastic file system standard efs standard', dt).join(' ')),
			 ...
			 this.createVertexTemplateEntry(n + 's3_files;',
					 s * 78, s * 78, '', 'S3 Files', null, null, this.getTagsForStencil(gn, 's3 files', dt).join(' ')),
	...
	// Icons whose artwork AWS dropped from the official icon package. The stencils
	// stay in aws4.xml so existing diagrams render; the sidebar entries live in this
	// default-off set (legacy icon policy) and rank below current shapes in search.
	Sidebar.prototype.addAWS4RetiredPalette = function()
	{
		var s = 1;
		var w2 = s * 78;
		var gn = 'mxgraph.aws4';
		var dt = 'aws amazon web service retired legacy ';
		var pts = 'points=[[0,0,0],[0.25,0,0],[0.5,0,0],[0.75,0,0],[1,0,0],[0,1,0],[0.25,1,0],[0.5,1,0],[0.75,1,0],[1,1,0],[0,0.25,0],[0,0.5,0],[0,0.75,0],[1,0.25,0],[1,0.5,0],[1,0.75,0]];';
		var svc = function(color)
		{
			return 'sketch=0;' + pts + 'outlineConnect=0;fontColor=#232F3E;fillColor=' + color + ';strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + '=mxgraph.aws4.resourceIcon;resIcon=' + gn + '.';
		};
		var res = function(color)
		{
			return 'sketch=0;outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=' + color + ';strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;pointerEvents=1;' + mxConstants.STYLE_SHAPE + '=mxgraph.aws4.';
		};
		// Migration & Modernization and End User Computing resource styles carry no
		// pointerEvents key (mxStencil defaults to 0) - their entries keep parity
		var res0 = function(color)
		{
			return 'sketch=0;outlineConnect=0;fontColor=#232F3E;gradientColor=none;fillColor=' + color + ';strokeColor=none;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + '=mxgraph.aws4.';
		};
		// The deleted AR & VR palette used a gradient fill - kept so these entries
		// match the same shapes in existing diagrams
		var arvr = 'sketch=0;' + pts + 'outlineConnect=0;fontColor=#232F3E;gradientColor=#F34482;gradientDirection=north;fillColor=#BC1356;strokeColor=#ffffff;dashed=0;verticalLabelPosition=bottom;verticalAlign=top;align=center;html=1;fontSize=12;fontStyle=0;aspect=fixed;' + mxConstants.STYLE_SHAPE + '=mxgraph.aws4.resourceIcon;resIcon=' + gn + '.';

		this.setCurrentSearchEntryLibrary('aws4r', 'aws4r');
		this.addPaletteFunctions('aws4r', 'AWS (retired)', false,
		[
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'kinesis_data_analytics;',
					 w2, w2, '', 'Kinesis Data Analytics (retired)', null, null, this.getTagsForStencil(gn, 'kinesis data analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#8C4FFF') + 'quicksight_paginated_reports;',
					 s * 62, s * 78, '', 'QuickSight Paginated Reports (retired)', null, null, this.getTagsForStencil(gn, 'quicksight paginated reports analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'quicksight;',
					 w2, w2, '', 'QuickSight (retired)', null, null, this.getTagsForStencil(gn, 'quicksight quick sight analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'sql_workbench;',
					 w2, w2, '', 'SQL Workbench (retired)', null, null, this.getTagsForStencil(gn, 'sql workbench analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'event_resource;',
					 s * 78, s * 78, '', 'Event Resource (retired)', null, null, this.getTagsForStencil(gn, 'event resource application integration', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'workdocs;',
					 w2, w2, '', 'WorkDocs (retired)', null, null, this.getTagsForStencil(gn, 'workdocs end user computing business applications', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'outposts_family;',
					 w2, w2, '', 'Outposts Family (retired)', null, null, this.getTagsForStencil(gn, 'outposts family compute', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'eks_cloud;',
					 w2, w2, '', 'EKS Cloud (retired)', null, null, this.getTagsForStencil(gn, 'eks cloud container containers', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'server_migration_service;',
					 w2, w2, '', 'Server Migration Service (retired)', null, null, this.getTagsForStencil(gn, 'server migration service sms migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'migration_hub;',
					 w2, w2, '', 'Migration Hub (retired)', null, null, this.getTagsForStencil(gn, 'migration hub migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(res0('#01A88D') + 'migration_hub_refactor_spaces_applications;',
					 s * 78, s * 78, '', 'Migration Hub Refactor Spaces Applications (retired)', null, null, this.getTagsForStencil(gn, 'migration hub refactor spaces applications migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(res0('#01A88D') + 'migration_hub_refactor_spaces_environments;',
					 s * 78, s * 78, '', 'Migration Hub Refactor Spaces Environments (retired)', null, null, this.getTagsForStencil(gn, 'migration hub refactor spaces environments migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(res0('#01A88D') + 'migration_hub_refactor_spaces_services;',
					 s * 78, s * 78, '', 'Migration Hub Refactor Spaces Services (retired)', null, null, this.getTagsForStencil(gn, 'migration hub refactor spaces services migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'transfer_for_sftp;',
					 w2, w2, '', 'Transfer for SFTP (retired)', null, null, this.getTagsForStencil(gn, 'transfer for sftp migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'deepcomposer;',
					 w2, w2, '', 'DeepComposer (retired)', null, null, this.getTagsForStencil(gn, 'deepcomposer ai artificial intelligence machine learning', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'lookout_for_metrics;',
					 w2, w2, '', 'Lookout for Metrics (retired)', null, null, this.getTagsForStencil(gn, 'lookout for metrics ai artificial intelligence machine learning', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'deeplens;',
					 w2, w2, '', 'DeepLens (retired)', null, null, this.getTagsForStencil(gn, 'deeplens ai artificial intelligence machine learning', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'quantum_ledger_database;',
					 w2, w2, '', 'Quantum Ledger Database (Blockchain, retired)', null, null, this.getTagsForStencil(gn, 'quantum ledger database blockchain', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#C925D1') + 'quantum_ledger_database;',
					 w2, w2, '', 'Quantum Ledger Database (Database, retired)', null, null, this.getTagsForStencil(gn, 'quantum ledger database db', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#DD344C') + 'alexa_for_business;',
					 w2, w2, '', 'Alexa for Business (retired)', null, null, this.getTagsForStencil(gn, 'alexa for business business applications', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#DD344C') + 'honeycode;',
					 w2, w2, '', 'Honeycode (retired)', null, null, this.getTagsForStencil(gn, 'honeycode business applications', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'application_cost_profiler;',
					 w2, w2, '', 'Application Cost Profiler (retired)', null, null, this.getTagsForStencil(gn, 'application cost profiler cost management cloud financial management', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'nice_enginframe;',
					 w2, w2, '', 'NICE EnginFrame (retired)', null, null, this.getTagsForStencil(gn, 'nice enginframe compute', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'genomics_cli;',
					 w2, w2, '', 'Genomics CLI (retired)', null, null, this.getTagsForStencil(gn, 'genomics cli compute', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'vmware_cloud_on_aws;',
					 w2, w2, '', 'VMware Cloud on AWS (retired)', null, null, this.getTagsForStencil(gn, 'vmware cloud on aws virtual machine vm compute', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#C925D1') + 'rds_on_vmware;',
					 w2, w2, '', 'RDS on VMware (retired)', null, null, this.getTagsForStencil(gn, 'rds on vmware db database', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#C925D1') + 'codestar;',
					 w2, w2, '', 'CodeStar (retired)', null, null, this.getTagsForStencil(gn, 'codestar dev developer tools', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'appstream_20;',
					 w2, w2, '', 'AppStream 2.0 (retired)', null, null, this.getTagsForStencil(gn, 'appstream 2.0 workspaces applications end user computing', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'worklink;',
					 w2, w2, '', 'WorkLink (retired)', null, null, this.getTagsForStencil(gn, 'worklink end user computing', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'workspaces_family;',
					 w2, w2, '', 'WorkSpaces Family (retired)', null, null, this.getTagsForStencil(gn, 'workspaces family end user computing', dt).join(' ')),
			 this.createVertexTemplateEntry(res0('#01A88D') + 'workspaces_family_amazon_workspaces;',
					 s * 78, s * 73, '', 'WorkSpaces Family Amazon WorkSpaces (retired)', null, null, this.getTagsForStencil(gn, 'workspaces family end user computing', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'gamekit;',
					 w2, w2, '', 'GameKit (retired)', null, null, this.getTagsForStencil(gn, 'gamekit games game tech', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'gamesparks;',
					 w2, w2, '', 'GameSparks (retired)', null, null, this.getTagsForStencil(gn, 'gamesparks games game tech', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'lumberyard;',
					 w2, w2, '', 'Lumberyard (retired)', null, null, this.getTagsForStencil(gn, 'lumberyard games game tech', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'open_3d_engine;',
					 w2, w2, '', 'Open 3D Engine (retired)', null, null, this.getTagsForStencil(gn, 'open 3d engine o3de games game tech', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'iot_analytics;',
					 w2, w2, '', 'IoT Analytics (retired)', null, null, this.getTagsForStencil(gn, 'iot analytics internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#7AA116') + 'iot_analytics_channel;',
					 s * 65, s * 78, '', 'IoT Analytics Channel (retired)', null, null, this.getTagsForStencil(gn, 'iot analytics channel internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#7AA116') + 'iot_analytics_data_store;',
					 s * 54, s * 78, '', 'IoT Analytics Data Store (retired)', null, null, this.getTagsForStencil(gn, 'iot analytics data store internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#7AA116') + 'iot_analytics_pipeline;',
					 s * 78, s * 42, '', 'IoT Analytics Pipeline (retired)', null, null, this.getTagsForStencil(gn, 'iot analytics pipeline internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#7AA116') + 'data_set;',
					 s * 63, s * 78, '', 'IoT Analytics Data Set (retired)', null, null, this.getTagsForStencil(gn, 'iot analytics data set internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'iot_button;',
					 w2, w2, '', 'IoT Button (retired)', null, null, this.getTagsForStencil(gn, 'iot button internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'iot_1click;',
					 w2, w2, '', 'IoT 1-Click (retired)', null, null, this.getTagsForStencil(gn, 'iot 1 click one internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'iot_edukit;',
					 w2, w2, '', 'IoT EduKit (retired)', null, null, this.getTagsForStencil(gn, 'iot edukit internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'iot_roborunner;',
					 w2, w2, '', 'IoT RoboRunner (retired)', null, null, this.getTagsForStencil(gn, 'iot roborunner internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'iot_things_graph;',
					 w2, w2, '', 'IoT Things Graph (retired)', null, null, this.getTagsForStencil(gn, 'iot things graph internet of things', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#E7157B') + 'mobile_application;',
					 w2, w2, '', 'Console Mobile Application (retired)', null, null, this.getTagsForStencil(gn, 'console mobile application management governance application integration', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#E7157B') + 'opsworks;',
					 w2, w2, '', 'OpsWorks (retired)', null, null, this.getTagsForStencil(gn, 'opsworks management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'opsworks_apps;',
					 s * 78, s * 78, '', 'OpsWorks Apps (retired)', null, null, this.getTagsForStencil(gn, 'opsworks apps management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'deployments;',
					 s * 65, s * 78, '', 'OpsWorks Deployments (retired)', null, null, this.getTagsForStencil(gn, 'opsworks deployments management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'layers;',
					 s * 78, s * 78, '', 'OpsWorks Layers (retired)', null, null, this.getTagsForStencil(gn, 'opsworks layers management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'monitoring;',
					 s * 78, s * 58, '', 'OpsWorks Monitoring (retired)', null, null, this.getTagsForStencil(gn, 'opsworks monitoring management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'opsworks_permissions;',
					 s * 54, s * 78, '', 'OpsWorks Permissions (retired)', null, null, this.getTagsForStencil(gn, 'opsworks permissions management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#E7157B') + 'resources;',
					 s * 68, s * 78, '', 'OpsWorks Resources (retired)', null, null, this.getTagsForStencil(gn, 'opsworks resources management governance', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'elastic_transcoder;',
					 w2, w2, '', 'Elastic Transcoder (retired)', null, null, this.getTagsForStencil(gn, 'elastic transcoder media services', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'nimble_studio;',
					 w2, w2, '', 'Nimble Studio (retired)', null, null, this.getTagsForStencil(gn, 'nimble studio media services', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'thinkbox_draft;',
					 w2, w2, '', 'Thinkbox Draft (retired)', null, null, this.getTagsForStencil(gn, 'thinkbox draft media services', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#ED7100') + 'thinkbox_sequoia;',
					 w2, w2, '', 'Thinkbox Sequoia (retired)', null, null, this.getTagsForStencil(gn, 'thinkbox sequoia media services', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#01A88D') + 'snowmobile;',
					 w2, w2, '', 'Snowmobile (Migration, retired)', null, null, this.getTagsForStencil(gn, 'snowmobile migration transfer', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'snowmobile;',
					 w2, w2, '', 'Snowmobile (Storage, retired)', null, null, this.getTagsForStencil(gn, 'snowmobile storage', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'snowcone;',
					 w2, w2, '', 'Snowcone (retired)', null, null, this.getTagsForStencil(gn, 'snowcone storage', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#7AA116') + 'infrequent_access_storage_class;',
					 w2, w2, '', 'Infrequent Access Storage Class (retired)', null, null, this.getTagsForStencil(gn, 'infrequent access storage class s3 standard ia storage', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'private_5g;',
					 w2, w2, '', 'Private 5G (retired)', null, null, this.getTagsForStencil(gn, 'private 5g networking content delivery', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#8C4FFF') + 'route_53_application_recovery_controller;',
					 s * 78, s * 78, '', 'Route 53 Application Recovery Controller (retired)', null, null, this.getTagsForStencil(gn, 'route 53 application recovery controller networking content delivery', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#8C4FFF') + 'emr_engine_mapr_m3;',
					 s * 78, s * 59, '', 'EMR Engine MapR M3 (retired)', null, null, this.getTagsForStencil(gn, 'emr engine mapr m3 analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#8C4FFF') + 'emr_engine_mapr_m5;',
					 s * 78, s * 59, '', 'EMR Engine MapR M5 (retired)', null, null, this.getTagsForStencil(gn, 'emr engine mapr m5 analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#8C4FFF') + 'emr_engine_mapr_m7;',
					 s * 78, s * 59, '', 'EMR Engine MapR M7 (retired)', null, null, this.getTagsForStencil(gn, 'emr engine mapr m7 analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'data_pipeline;',
					 w2, w2, '', 'Data Pipeline (retired)', null, null, this.getTagsForStencil(gn, 'data pipeline analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#8C4FFF') + 'glue_elastic_views;',
					 w2, w2, '', 'Glue Elastic Views (retired)', null, null, this.getTagsForStencil(gn, 'glue elastic views analytics', dt).join(' ')),
			 this.createVertexTemplateEntry(arvr + 'sumerian;',
					 w2, w2, '', 'Sumerian (retired)', null, null, this.getTagsForStencil(gn, 'sumerian ar vr augmented virtual reality', dt).join(' ')),
			 this.createVertexTemplateEntry(arvr + 'ar_vr;',
					 w2, w2, '', 'AR & VR (retired)', null, null, this.getTagsForStencil(gn, 'ar vr augmented virtual reality category', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#DD344C') + 'robotics;',
					 w2, w2, '', 'Robotics (retired)', null, null, this.getTagsForStencil(gn, 'robotics category', dt).join(' ')),
			 this.createVertexTemplateEntry(svc('#DD344C') + 'robomaker;',
					 w2, w2, '', 'RoboMaker (retired)', null, null, this.getTagsForStencil(gn, 'robomaker robotics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#DD344C') + 'cloud_extension_ros;',
					 s * 78, s * 78, '', 'RoboMaker Cloud Extensions ROS (retired)', null, null, this.getTagsForStencil(gn, 'robomaker cloud extensions ros robotics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#DD344C') + 'development_environment;',
					 s * 78, s * 71, '', 'RoboMaker Development Environment (retired)', null, null, this.getTagsForStencil(gn, 'robomaker development environment robotics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#DD344C') + 'fleet_management;',
					 s * 78, s * 78, '', 'RoboMaker Fleet Management (retired)', null, null, this.getTagsForStencil(gn, 'robomaker fleet management robotics', dt).join(' ')),
			 this.createVertexTemplateEntry(res('#DD344C') + 'simulation;',
					 s * 78, s * 64, '', 'RoboMaker Simulation (retired)', null, null, this.getTagsForStencil(gn, 'robomaker simulation robotics', dt).join(' '))
		]);
		this.setCurrentSearchEntryLibrary();
	};
})();
